<template>
  <div class="flex h-screen overflow-hidden">
      ...
      <div class="h-full flex flex-col">
        ...
        <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
          <router-link
            ...
            :class="$route.path === item.path ? 'bg-gradient-to-r from-blue-500/20 to-purple-600/20 text-blue-400 border border-blue-500/30' : 'text-slate-300'"
          >
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
      <!-- Topbar -->
      <header class="h-16 bg-slate-800/50 backdrop-blur-sm border-b border-slate-700 flex items-center justify-between px-6">
        <button @click="sidebarOpen = !sidebarOpen" class="lg:hidden p-2 hover:bg-slate-700 rounded-lg">
      ...
      <transition-group name="toast">
        ...
        >
          <div class="flex-shrink-0">
            ...
            <svg v-else-if="t.type === 'warning'" class="w-5 h-5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
          ...
          <button @click="toast.remove(t.id)" class="flex-shrink-0 text-slate-400 hover:text-white">
